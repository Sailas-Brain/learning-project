    ...
    <div class="header__top-wrap">
      <div class="header__top">
        ...
        <div class="header__icons">
          <button class="header__icons-registration">
            <svg width="30" height="30" viewBox="0 0 30 31" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M15 2.69531C12.9545 2.69531 11.3565 3.43942 10.206 4.92765C9.0554 6.41587 8.48011 8.31827 8.48011 10.6349C8.46591 13.513 9.40341 15.7945 11.2926 17.4793C11.5341 17.7039 11.6193 17.9917 11.5483 18.3427L11.0582 19.3536C10.902 19.6906 10.6712 19.9538 10.3658 20.1433C10.0604 20.3329 9.41761 20.6031 8.4375 20.9541C8.39489 20.9682 7.49645 21.256 5.74219 21.8176C3.98793 22.3792 3.05398 22.6881 2.94034 22.7442C1.74716 23.2356 0.965909 23.7481 0.596591 24.2816C0.198864 25.1661 0 27.4055 0 30.9997H30C30 27.4055 29.8011 25.1661 29.4034 24.2816C29.0341 23.7481 28.2528 23.2356 27.0597 22.7442C26.946 22.6881 26.0121 22.3792 24.2578 21.8176C22.5036 21.256 21.6051 20.9682 21.5625 20.9541C20.5824 20.6031 19.9396 20.3329 19.6342 20.1433C19.3288 19.9538 19.098 19.6906 18.9418 19.3536L18.4517 18.3427C18.3807 17.9917 18.4659 17.7039 18.7074 17.4793C20.5966 15.7945 21.5341 13.513 21.5199 10.6349C21.5199 8.31827 20.9446 6.41587 19.794 4.92765C18.6435 3.43942 17.0455 2.69531 15 2.69531Z" fill="white"/>
            </svg>
          </button>
          ...
          <div class="header__social">
            <a class="header__social-icon" href="#">
              <svg width="23" height="23" viewBox="0 0 23 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g clip-path="url(#clip0_4902_273)">
